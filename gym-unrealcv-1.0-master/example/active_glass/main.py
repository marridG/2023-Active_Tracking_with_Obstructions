...
parser.add_argument('--workers', type=int, default=0, metavar='W', help='how many training processes to use')
parser.add_argument('--num-steps', type=int, default=20, metavar='NS', help='number of forward steps in A3C')
parser.add_argument('--test-eps', type=int, default=50, metavar='TE', help='maximum length of an episode')
...
parser.add_argument('--env-base', default='UnrealGlassLocate-GlassRoomglass-DiscreteColor-v0', metavar='ENVB', help='environment to test on ')
...
parser.add_argument('--load_model_dir', default=None, metavar='LMD', help='folder to load trained models from')#'/home/user/project/glass/gym-unrealcv-1.0/example/active_glass/ckpt/0132-all-new.dat'
...
parser.add_argument('--network', default='cnn-lstm', metavar='M', help='config Network Architecture')
parser.add_argument('--aux', default='none', metavar='A', help='auxiliary task: reward/none')
parser.add_argument('--gpu-ids', type=int, default=[0, 1, 2, 3, 4, 5, 6], nargs='+', help='GPUs to use [-1 CPU only] (default: -1)')
parser.add_argument('--obs', default='img', metavar='O', help='img or vector')
parser.add_argument('--single', dest='single', action='store_false', help='run on single agent env')
...
parser.add_argument('--shared-optimizer', dest='shared_optimizer', action='store_false', help='use a shared optimizer')
parser.add_argument('--split', dest='split', action='store_true', help='split model to save')
parser.add_argument('--train-mode', type=int, default=0, metavar='TM', help='which agent to train(0:tracker 1:target)')
...
parser.add_argument('--sleep-time', type=int, default=10, metavar='ST', help='seconds to sleep after a process launched')
...
parser.add_argument('--intrinsic-reward', default=True, metavar='int_reward', help='use intrinsic reward to help exploration')
# Based on
...
if __name__ == '__main__':
    ...
    env = create_env(args.env, args, 'nousehere')
    # print(env.observation_space)    # [Box(255, 1, (1, 80, 80), uint8)]
